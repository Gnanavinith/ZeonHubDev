...
const Contact = () => {
  return (
    <div className="relative w-full min-h-[350px] bg-gray-900 text-white flex flex-col items-center justify-center text-center px-6 py-16 overflow-hidden">
  ...
  <Link to="/contact">
  <motion.button 
        className="mt-10 px-6 py-3 bg-blue-700 text-white font-lg rounded-full hover:bg-blue-500 transition duration-300 flex items-center gap-2 "
        initial={{ scale: 0.9 }}
        animate={{ scale: 1 }}
