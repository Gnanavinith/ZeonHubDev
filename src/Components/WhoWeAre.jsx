  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-5xl">
        ...
        <div className="flex flex-wrap justify-center gap-30 mt-8">
          {statsData.map((item, index) => (
            <motion.div
              ...
              className="relative bg-gray-800 p-8 rounded-2xl shadow-2xl w-[140px] sm:w-[160px] flex flex-col items-center 
